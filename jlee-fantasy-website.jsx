...
function runSelfTests() {
  ...
  console.assert(
    services.some((service) => service.title === "Ecommerce Solutions"),
    "Expected Ecommerce Solutions service to be present."
  );
  console.assert(courseFeatures.length === 4, "Expected 4 course feature cards.");
  console.assert(
    paymentMethods.includes("Credit/Debit Card") && paymentMethods.includes("PayPal"),
    "Expected primary payment methods to be present."
  );
...
export default function JLeeFantasyServicesWebsite() {
  return (
      ...
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-slate-950 via-blue-900 to-yellow-500 text-white shadow-lg">
              <Star size={23} />
            </div>
            <div>
          ...
          <Button className="rounded-2xl bg-slate-950 text-white hover:bg-blue-900">
            Book Consultation
          </Button>
        </div>
      </header>
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-12 md:grid-cols-2">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Button className="rounded-2xl bg-blue-700 px-7 py-6 text-base hover:bg-blue-800">
                  Request a Consultation <ArrowRight className="ml-2" size={18} />
                </Button>
                <Button variant="outline" className="rounded-2xl px-7 py-6 text-base">
                  Explore Services
                </Button>
              </div>
            </motion.div>
              ...
              {services.map((service, index) => {
                ...
                return (
                  <motion.div key={service.title} initial={{ opacity: 0, y: 22 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: index * 0.06 }}>
                    <Card className="h-full rounded-3xl border border-slate-100 bg-white shadow-md transition hover:-translate-y-1 hover:shadow-2xl">
        ...
        <section id="store" className="bg-white px-6 py-16">
          <div className="mx-auto max-w-7xl">
            <div className="grid items-center gap-10 lg:grid-cols-2">
              ...
              <Card className="rounded-[2rem] border-0 bg-gradient-to-br from-blue-900 to-slate-950 text-white shadow-2xl">
                <CardContent className="p-8">
                  ...
                  <Button className="mt-6 rounded-2xl bg-yellow-500 text-slate-950 hover:bg-yellow-400">View Store Preview</Button>
                </CardContent>
              </Card>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {paymentMethods.map((method) => (
                <Card key={method} className="rounded-3xl border-0 bg-white text-center shadow-md">
          ...
          <div className="mx-auto max-w-7xl rounded-[2rem] bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 p-8 text-white shadow-2xl md:p-12">
            <div className="grid gap-10 lg:grid-cols-2">
              ...
              <div className="space-y-4 text-slate-200">
                ...
                <Button className="mt-4 rounded-2xl bg-yellow-500 px-7 py-6 text-base font-bold text-slate-950 hover:bg-yellow-400">
